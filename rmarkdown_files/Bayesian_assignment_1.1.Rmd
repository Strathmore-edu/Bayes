...
# Simulate the following data and fit the linear model in R by 
    ##1. Using "lm"
    ##2. Using quasi Newton ("optim") 
    ##3. Using Newton Raphson by first principle
    
    ##|theta^t-theta^t-1| < 0.0001 sama as abs(thetahatnew-thetahatcurr) < 0.0001
...
#Parameters
    ...
    Sexi = rbinom(150, 1, 0.52)  #outcome of 150 observations with trial set to 1 and 0.
...
```{r newton_raphson_method, include=TRUE}
